# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-01-30 14:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('commodity', '0005_auto_20190124_1732'),
        ('user', '0009_auto_20190129_1946'),
        ('order', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='商品总金额')),
                ...
                ('order_price', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='订单金额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updatetime', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('goods_sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='commodity.CommoditySkuModel', verbose_name='订单商品ID')),
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='order.Payment', verbose_name='支付方式'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
